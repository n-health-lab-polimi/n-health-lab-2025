# Laboratory of Nearable Technology for Health Data Science 2024-2025
...
To _clone_ the repository, i.e., have a synced copy in your local computer, use the URL https://github.com/n-health-lab-polimi/n-health-lab-2026.git from your Git client. 
If you feel bold, you can use the git command line

```
git clone [https://github.com/marcobrando/n-health-lab.git](https://github.com/n-health-lab-polimi/n-health-lab-2026.git)
```
